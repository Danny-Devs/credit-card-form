...
<template>
  <main :class="mobile ? 'mobileBackground' : 'desktopBackground'" h-screen px-6 pt-6>
    ...
    <!-- form -->
    <Form tracking-widest mt-30 class="sm:ml-[58%] md:ml-[51%] lg:ml-[42%] xl:ml-[34%] md:mr-[3%] lg:mr-[15%] xl:mr-[20%]">
      <p text-xs font-bold mb-2>
        CARDHOLDER NAME
      </p>
      <Field name="cardholder-name" mb-5 border-1 border-gray-400 px-4 py-2 rounded-lg type="text" class="w-[100%]" placeholder="e.g. Jane Appleseed" />

      <p text-xs font-bold mb-2>
        CARD NUMBER
      </p>
      <Field name="card-number" type="number" class="w-[100%]" mb-5 border-1 border-gray-400 px-4 py-2 rounded-lg placeholder="e.g. 1234 5678 9123 0000" />
      <!-- flexbox bottom row -->
      <div flex gap-3 mb-7>
        <div class="basis-1/2">
          <p text-xs font-bold mb-2>
          ...
          <div flex gap-2>
            <Field name="month" type="number" class="w-[50%]" placeholder="MM" border-1 border-gray-400 px-4 py-2 rounded-lg />
            <Field name="year" type="number" class="w-[50%]" placeholder="YY" border-1 border-gray-400 px-4 py-2 rounded-lg />
          </div>
        </div>
        <div class="basis-1/2" self-end>
          ...
          <Field name="cvc" type="number" w-full placeholder="e.g. 123" border-1 border-gray-400 px-4 py-2 rounded-lg />
        </div>
      </div>

      <div>
        <button type="submit" w-full rounded-lg bg-black text-white py-4>
          Confirm
        </button>
      </div>
    </Form>
